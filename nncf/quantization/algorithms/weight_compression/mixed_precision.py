...
class MixedPrecisionCriterion(Algorithm):
    ...
    def apply(
        ...
        weight_params_valid_for_primary_precision: Optional[list[WeightCompressionParameters]] = None,
    ) -> None:
        """
        ...
        if weight_params_valid_for_primary_precision is None:
            weight_params_valid_for_primary_precision = weight_params

        scores = self._calc_sensitivity(model, graph, weight_params_valid_for_primary_precision, statistic_points)
        ...
        for index in indexes_of_layers_in_ascending_order_of_scores:
            weight_param = weight_params_valid_for_primary_precision[index]
